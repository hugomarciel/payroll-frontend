  ...
  const listOptions = () => (
    ...
    >
      <List>
        ...
        <ListItemButton onClick={() => navigate("/justification/list")}>
          <ListItemIcon>
            <MoreTimeIcon />
          </ListItemIcon>
          <ListItemText primary="Justifications" />
        </ListItemButton>


        <ListItemButton onClick={() => navigate("/autorization/list")}>
          <ListItemIcon>
            <MoreTimeIcon />
          </ListItemIcon>
          <ListItemText primary="Autorizations" />
        </ListItemButton>

        <ListItemButton onClick={() => navigate("/inandoutreg")}>
          <ListItemIcon>
            <MoreTimeIcon />
          </ListItemIcon>
          <ListItemText primary="Registro de entradas y salidas" />
        </ListItemButton>

        <ListItemButton onClick={() => navigate("/extrahour/calculate")}>
          <ListItemIcon>
            <MoreTimeIcon />
          </ListItemIcon>
          <ListItemText primary="Calculo de horas extras" />
        </ListItemButton>
